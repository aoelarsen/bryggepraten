...
const Prisliste = () => {
  ...
  return (
    <section className='p-2 my-2 border border-slate-100 bg-white rounded-xs drop-shadow-lg grid'>
      ...
      <div className='my-4'>
        ...
        {booksBrygge ? booksBrygge.map(book => {return (
          <div className='w-full grid grid-cols-[1fr_auto]  hover:bg-slate-50 leading-loose'>
            <div>{book.tittel}</div>
      ...
      <div className='my-4'>
        ...
        {booksOther ? booksOther.map(book => {return (<div className='w-full grid grid-cols-[1fr_auto] md:grid-cols-3 hover:bg-slate-50 leading-loose' >
            <div>{book.tittel}</div>
      ...
      {/* <a href='#' className='p-2 m-2 border border-gray-200 text-center rounded-xs w-full md:w-36 justify-self-center md:justify-self-end shadow-xs focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100 bg-[#efb261] text-black text-secondary hover:text-amber-100 hover:bg-yellow-900'>Bestill her</a> */}
    </section>
  )
}
